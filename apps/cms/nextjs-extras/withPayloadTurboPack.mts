...
interface WithPayloadTurboPackOptions {
  devBundleServerPackages?: boolean
}

export const withPayloadTurboPack = (
  nextConfig: NextConfig,
  options: WithPayloadTurboPackOptions = {},
) => {
  ...
  const toReturn = {
    ...
    headers: async () => {
      const headersFromConfig =
        'headers' in nextConfig && typeof nextConfig.headers === 'function'
    ...
    turbopack: {
      // Preserve any existing Turbopack configuration
...
export default withPayloadTurboPack
