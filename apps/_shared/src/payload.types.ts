...
export interface Config {
  ...
  collectionsSelect: {
    ...
    navigation_items: NavigationItemsSelect<false> | NavigationItemsSelect<true>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "navigation_items".
 */
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'navigation_items';
        value: string | NavigationItem;
      } | null);
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "navigation_items_select".
 */
